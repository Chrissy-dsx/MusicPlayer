...
class MainUI:
    ...
    def artist_function(self):
        ...
        top_singer = df['Artist'].str.split(',').explode().str.strip()
        top_singer_count=top_singer.value_counts()
        #top_singer = df['Artist'].value_counts().nlargest(10)  # Get the top ten artists with the most appearances
        print(top_singer_count.head(10))
        top_singer=top_singer_count.head(10)
        print('1')
